...
experiment = Experiment(parameter_space,                   # defines the parameter space this experiment is helping to explore
...
optimizer = DummyOptimizer(name="dummy optimizer",

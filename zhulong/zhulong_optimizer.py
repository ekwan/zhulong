...
parameter_space = ParameterSpace(starting_material, reagents, solvents,
                                 ...
                                 total_volume=350,          # add solvent to make the final volume in each experiment 250 uL
...
acquisition_list = ['PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI','PI','UCB','EI']
...
for r in range(n_total):
    ...
    para_r = optimization(dat, parameter_bounds,method, seed = 1234, initMethod = initMethod, acquisition = acquisition_list[r])
